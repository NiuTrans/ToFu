// @ts-check
/* Generated lazy retained runtime: image-generation. Do not edit directly. */
import { featureRegistry as runtimeScope } from '../feature-registry';
import { escapeHtml } from '../html-safety';

const Api = runtimeScope.Api;
if (!Api || typeof Api !== 'object') throw new Error('image-generation runtime dependency is unavailable: Api');
const Icon = runtimeScope.Icon;
if (typeof Icon !== 'function') throw new Error('image-generation runtime dependency is unavailable: Icon');
const ImageGenerationComposerState = runtimeScope.ImageGenerationComposerState;
if (!ImageGenerationComposerState || typeof ImageGenerationComposerState !== 'object') throw new Error('image-generation runtime dependency is unavailable: ImageGenerationComposerState');
const _applyImageGenUI = runtimeScope._applyImageGenUI;
if (typeof _applyImageGenUI !== 'function') throw new Error('image-generation runtime dependency is unavailable: _applyImageGenUI');
const _buildConvSettings = runtimeScope._buildConvSettings;
if (typeof _buildConvSettings !== 'function') throw new Error('image-generation runtime dependency is unavailable: _buildConvSettings');
const _brandSvg = runtimeScope._brandSvg;
if (typeof _brandSvg !== 'function') throw new Error('image-generation runtime dependency is unavailable: _brandSvg');
const _detectBrand = runtimeScope._detectBrand;
if (typeof _detectBrand !== 'function') throw new Error('image-generation runtime dependency is unavailable: _detectBrand');
const _modelBrand = runtimeScope._modelBrand;
if (typeof _modelBrand !== 'function') throw new Error('image-generation runtime dependency is unavailable: _modelBrand');
const _modelShortName = runtimeScope._modelShortName;
if (typeof _modelShortName !== 'function') throw new Error('image-generation runtime dependency is unavailable: _modelShortName');
const _scheduleReflow = runtimeScope._scheduleReflow;
if (typeof _scheduleReflow !== 'function') throw new Error('image-generation runtime dependency is unavailable: _scheduleReflow');
const _waitForImageProcessing = runtimeScope._waitForImageProcessing;
if (typeof _waitForImageProcessing !== 'function') throw new Error('image-generation runtime dependency is unavailable: _waitForImageProcessing');
const apiUrl = runtimeScope.apiUrl;
if (typeof apiUrl !== 'function') throw new Error('image-generation runtime dependency is unavailable: apiUrl');
const captureActiveConversationSettings = runtimeScope.captureActiveConversationSettings;
if (typeof captureActiveConversationSettings !== 'function') throw new Error('image-generation runtime dependency is unavailable: captureActiveConversationSettings');
const debugLog = runtimeScope.debugLog;
if (typeof debugLog !== 'function') throw new Error('image-generation runtime dependency is unavailable: debugLog');
const getActiveConv = runtimeScope.getActiveConv;
if (typeof getActiveConv !== 'function') throw new Error('image-generation runtime dependency is unavailable: getActiveConv');
const renderConversationList = runtimeScope.renderConversationList;
if (typeof renderConversationList !== 'function') throw new Error('image-generation runtime dependency is unavailable: renderConversationList');
const renderImagePreviews = runtimeScope.renderImagePreviews;
if (typeof renderImagePreviews !== 'function') throw new Error('image-generation runtime dependency is unavailable: renderImagePreviews');
const scrollToBottom = runtimeScope.scrollToBottom;
if (typeof scrollToBottom !== 'function') throw new Error('image-generation runtime dependency is unavailable: scrollToBottom');
const updateSubmenuCounts = runtimeScope.updateSubmenuCounts;
if (typeof updateSubmenuCounts !== 'function') throw new Error('image-generation runtime dependency is unavailable: updateSubmenuCounts');
...
// BEGIN GENERATED LAZY RUNTIME PORTS — image-generation
runtimeScope._igCancelGeneration = _igCancelGeneration;
runtimeScope._igRetryGenerationTurn = _igRetryGenerationTurn;
runtimeScope._igUpdateGenButton = _igUpdateGenButton;
runtimeScope._loadIgModels = _loadIgModels;
// END GENERATED LAZY RUNTIME PORTS
// BEGIN GENERATED LAZY RUNTIME ACTIONS — image-generation
runtimeScope.enterImageGenMode = enterImageGenMode;
runtimeScope.exitImageGenMode = exitImageGenMode;
runtimeScope.generateImageDirect = generateImageDirect;
runtimeScope.selectIgAspect = selectIgAspect;
runtimeScope.selectIgCount = selectIgCount;
runtimeScope.selectIgModel = selectIgModel;
runtimeScope.selectIgResolution = selectIgResolution;
runtimeScope.toggleIgModelDropdown = toggleIgModelDropdown;
