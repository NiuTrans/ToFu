// @ts-check
/* Generated lazy retained runtime: knowledge-presenters. Do not edit directly. */
...
if (!Api || typeof Api !== 'object') throw new Error('knowledge-presenters runtime dependency is unavailable: Api');
const apiUrl = runtimeScope.apiUrl;
if (typeof apiUrl !== 'function') throw new Error('knowledge-presenters runtime dependency is unavailable: apiUrl');
const showConfirm = runtimeScope.showConfirm;
if (typeof showConfirm !== 'function') throw new Error('knowledge-presenters runtime dependency is unavailable: showConfirm');
const showToast = runtimeScope.showToast;
if (typeof showToast !== 'function') throw new Error('knowledge-presenters runtime dependency is unavailable: showToast');
...
// BEGIN GENERATED LAZY RUNTIME PORTS — knowledge-presenters
// END GENERATED LAZY RUNTIME PORTS
// BEGIN GENERATED LAZY RUNTIME ACTIONS — knowledge-presenters
runtimeScope._knowledgeApplyCatalog = _knowledgeApplyCatalog;
runtimeScope._knowledgeClearCatalog = _knowledgeClearCatalog;
runtimeScope._knowledgeDebounceCatalog = _knowledgeDebounceCatalog;
runtimeScope._knowledgeDismissUploadReport = _knowledgeDismissUploadReport;
runtimeScope._knowledgeDrag = _knowledgeDrag;
runtimeScope._knowledgeDrop = _knowledgeDrop;
runtimeScope._knowledgeGoPage = _knowledgeGoPage;
runtimeScope._knowledgeLoadMoreContent = _knowledgeLoadMoreContent;
runtimeScope._knowledgeRefresh = _knowledgeRefresh;
runtimeScope._knowledgeReindex = _knowledgeReindex;
runtimeScope._knowledgeRemove = _knowledgeRemove;
runtimeScope._knowledgeSearch = _knowledgeSearch;
runtimeScope._knowledgeSetCategory = _knowledgeSetCategory;
runtimeScope._knowledgeSetSort = _knowledgeSetSort;
runtimeScope._knowledgeToggle = _knowledgeToggle;
runtimeScope._knowledgeToggleContent = _knowledgeToggleContent;
runtimeScope._knowledgeToggleVisual = _knowledgeToggleVisual;
runtimeScope._knowledgeUpload = _knowledgeUpload;
runtimeScope.closeKnowledgeBase = closeKnowledgeBase;
runtimeScope.openKnowledgeBase = openKnowledgeBase;
