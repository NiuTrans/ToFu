// @ts-check
/* Generated lazy retained runtime: local-control-presenters. Do not edit directly. */
...
if (!Api || typeof Api !== 'object') throw new Error('local-control-presenters runtime dependency is unavailable: Api');
const BASE_PATH = runtimeScope.BASE_PATH;
if (BASE_PATH === undefined) throw new Error('local-control-presenters runtime dependency is unavailable: BASE_PATH');
const LocalControlShellState = runtimeScope.LocalControlShellState;
if (!LocalControlShellState || typeof LocalControlShellState !== 'object') throw new Error('local-control-presenters runtime dependency is unavailable: LocalControlShellState');
const _applyBrowserUI = runtimeScope._applyBrowserUI;
if (typeof _applyBrowserUI !== 'function') throw new Error('local-control-presenters runtime dependency is unavailable: _applyBrowserUI');
const _applyDesktopUI = runtimeScope._applyDesktopUI;
if (typeof _applyDesktopUI !== 'function') throw new Error('local-control-presenters runtime dependency is unavailable: _applyDesktopUI');
const _lcUpdateBadge = runtimeScope._lcUpdateBadge;
if (typeof _lcUpdateBadge !== 'function') throw new Error('local-control-presenters runtime dependency is unavailable: _lcUpdateBadge');
const _safeClipboardWrite = runtimeScope._safeClipboardWrite;
if (typeof _safeClipboardWrite !== 'function') throw new Error('local-control-presenters runtime dependency is unavailable: _safeClipboardWrite');
const apiUrl = runtimeScope.apiUrl;
if (typeof apiUrl !== 'function') throw new Error('local-control-presenters runtime dependency is unavailable: apiUrl');
const captureActiveConversationSettings = runtimeScope.captureActiveConversationSettings;
if (typeof captureActiveConversationSettings !== 'function') throw new Error('local-control-presenters runtime dependency is unavailable: captureActiveConversationSettings');
const updateSubmenuCounts = runtimeScope.updateSubmenuCounts;
if (typeof updateSubmenuCounts !== 'function') throw new Error('local-control-presenters runtime dependency is unavailable: updateSubmenuCounts');
...
// BEGIN GENERATED LAZY RUNTIME PORTS — local-control-presenters
runtimeScope.LocalControlPresentationState = LocalControlPresentationState;
// END GENERATED LAZY RUNTIME PORTS
// BEGIN GENERATED LAZY RUNTIME ACTIONS — local-control-presenters
