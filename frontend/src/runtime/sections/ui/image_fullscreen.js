/* ===== migrated source: ui/image_fullscreen.js ===== */
/* ═══════════════════════════════════════════════════════════════════
   ...
   browser_screenshot and image-gen cards), plus paper-reader.js.

   They previously lived in image-gen.js, which was moved to the DEFERRED
   lazy ESM domain (loaded only on first entry into Image-Gen mode). That
   ...
   bundle. See Vite's module graph (the migrated module graph) + index.html.

   This file is concatenated by Vite's module graph — symbols share the same
   window scope as every other frontend/src/runtime/*.js file. No exports/imports.
   ═══════════════════════════════════════════════════════════════════ */
