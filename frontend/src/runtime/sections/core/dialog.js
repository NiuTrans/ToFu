/* ===== migrated source: core/dialog.js ===== */
/* ═══════════════════════════════════════════════════════════════════
   ...
   This file is concatenated by Vite's module graph AFTER the slim core.js
...
if (typeof window !== 'undefined') {
  runtimeScope.showConfirm = showConfirm;
  runtimeScope.showAlert = showAlert;
  runtimeScope.showPrompt = showPrompt;
  runtimeScope.showChoice = showChoice;
}
