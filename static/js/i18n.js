...
var _i18n = {
  ...
  'ri.stateEmpty': { zh: '该轮次没有可用的状态镜像（未生成或已被清理）', en: 'No state mirror for this round (never captured or pruned)' },
  ...
  'settings.groupModels': { zh: '模型接入', en: 'Models' },
  'settings.groupFeatures': { zh: '能力', en: 'Features' },
  'settings.groupConnections': { zh: '连接', en: 'Connections' },
  'settings.groupSystem': { zh: '系统', en: 'System' },
  ...
  'settings.tabTools': { zh: '工具', en: 'Tools' },
  // ── Tools inventory panel (Settings → 工具) ──
  'toolsInv.title': { zh: '工具注册表', en: 'Tool Registry' },
  'toolsInv.intro': { zh: '这里实时列出本进程注册在案的全部工具（统一注册表 lib/tools/registry 的只读视图）。灰显家族表示当前门未开，附开启方式；每次打开都重新盘点，MCP 重连、插件装拆即刻反映。', en: 'A live read view of every tool registered in this process (the unified registry lib/tools/registry). Greyed families are currently gated off — the switch is shown; re-inventoried on every open, so MCP reconnects and plugin installs show up immediately.' },
  'toolsInv.searchPh': { zh: '搜索工具…', en: 'Search tools…' },
  'toolsInv.refresh': { zh: '刷新', en: 'Refresh' },
  'toolsInv.refreshTitle': { zh: '重新从服务器拉取实时盘点', en: 'Re-pull the live inventory from the server' },
  'toolsInv.filterAll': { zh: '全部', en: 'All' },
  'toolsInv.filterOn': { zh: '已启用', en: 'Active' },
  'toolsInv.filterOff': { zh: '未启用', en: 'Gated' },
  'toolsInv.countTotal': { zh: '{n} 个工具', en: '{n} tools' },
  'toolsInv.countActive': { zh: '{n} 个启用', en: '{n} active' },
  'toolsInv.stateOn': { zh: '启用', en: 'ON' },
  'toolsInv.stateOff': { zh: '未启用', en: 'OFF' },
  'toolsInv.stateStandby': { zh: '待机', en: 'STANDBY' },
  'toolsInv.stateError': { zh: '异常', en: 'ERROR' },
  'toolsInv.gateLabel': { zh: '开启方式：', en: 'Enable via: ' },
  'toolsInv.writeBadge': { zh: '写', en: 'write' },
  'toolsInv.writeTitle': { zh: '写/状态变更工具：走串行写分区 + 手动批准门', en: 'State-changing tool: serial write partition + manual approval gate' },
  'toolsInv.disabledBadge': { zh: '已禁用', en: 'disabled' },
  'toolsInv.pluginBadge': { zh: '插件', en: 'plugin' },
  'toolsInv.required': { zh: '必填参数:', en: 'Required:' },
  'toolsInv.familyEmpty': { zh: '（该家族当前未向模型暴露工具）', en: '(this family exposes no tools right now)' },
  'toolsInv.noMatch': { zh: '没有匹配的工具。', en: 'No tools match.' },
  'toolsInv.noResponse': { zh: '服务器未应答', en: 'No response from the server' },
  'toolsInv.loadFailed': { zh: '加载工具盘点失败: {err}', en: 'Failed to load the tool inventory: {err}' },
  'toolsInv.group.search': { zh: '搜索与抓取', en: 'Search & Fetch' },
  'toolsInv.group.project': { zh: '项目文件', en: 'Project Files' },
  'toolsInv.group.browser': { zh: '浏览器', en: 'Browser' },
  'toolsInv.group.desktop': { zh: '桌面 Agent', en: 'Desktop Agent' },
  'toolsInv.group.image': { zh: '图像生成', en: 'Image Generation' },
  'toolsInv.group.video': { zh: '视频与内容生产', en: 'Video & Production' },
  'toolsInv.group.conversation': { zh: '会话与项目大脑', en: 'Conversation & Project Brain' },
  'toolsInv.group.human': { zh: '人机协同', en: 'Human-in-the-loop' },
  'toolsInv.group.memory': { zh: '记忆', en: 'Memory' },
  'toolsInv.group.skills': { zh: '技能包', en: 'Skills' },
  'toolsInv.group.task': { zh: '任务管理', en: 'Task Management' },
  'toolsInv.group.scheduler': { zh: '调度与定时', en: 'Scheduler & Timers' },
  'toolsInv.group.swarm': { zh: '多智能体', en: 'Multi-agent Swarm' },
  'toolsInv.group.mcp': { zh: 'MCP 外部服务', en: 'MCP Servers' },
  'toolsInv.group.custom': { zh: '自定义工具', en: 'Custom Tools' },
  ...
  'update.bgHint': { zh: '你可以关闭此窗口，下载会在后台继续；完成后会通知你是否重启。', en: 'You can close this window — the download continues in the background and you will be asked about restarting when it finishes.' },
  'update.bgRunningToast': { zh: '更新在后台继续，完成后会通知你。', en: 'The update continues in the background — you will be notified when it finishes.' },
  'update.bgDoneTitle': { zh: '更新已下载完成（%s）', en: 'Update downloaded (%s)' },
  'update.bgDoneBody': { zh: '重启服务器以应用更新。', en: 'Restart the server to apply the update.' },
  'update.bgDoneHint': { zh: '点击此通知立即重启', en: 'Click this notification to restart now' },
  'update.bgFailTitle': { zh: '后台更新失败', en: 'Background update failed' },
  'update.bgFailHint': { zh: '点击查看详情', en: 'Click to view details' },
  ...
  'settings.egressAgentNoCap': { zh: '受控端在线但未允许转发订阅流量——在它的托盘菜单「Permissions → 允许转发订阅 API 流量」勾选即可（源码运行则用 --allow-egress 启动）', en: 'Agent online but egress relay is off — enable it in the agent tray under "Permissions → Allow relaying subscription API traffic" (source runs: start with --allow-egress)' },
  ...
  'onboard.apiCardTitle': { zh: '配置 API Key', en: 'API Key' },
  'onboard.apiCardDesc': { zh: '适用于 DeepSeek、OpenAI 兼容服务、自有网关或本地部署', en: 'For DeepSeek, OpenAI-compatible endpoints, your own gateway, or local deployments' },
  'onboard.oauthCardTitle': { zh: '订阅账号登录', en: 'Subscription login' },
  'onboard.oauthCardDesc': { zh: '用 Claude Pro / Max 或 ChatGPT Plus 订阅额度，无需 API Key', en: 'Use a Claude Pro / Max or ChatGPT Plus subscription — no API key needed' },
  'onboard.skip': { zh: '跳过，稍后在设置中配置', en: 'Skip — configure later in Settings' },
  'onboard.back': { zh: '上一步', en: 'Back' },
  'onboard.stepOf': { zh: '第 {a} 步 / 共 {b} 步', en: 'Step {a} of {b}' },
  'onboard.apiTitle': { zh: '填入服务商地址和密钥，剩下的交给自动探测', en: 'Enter the endpoint and key — probing handles the rest' },
  'onboard.apiUrlLabel': { zh: 'Base URL', en: 'Base URL' },
  'onboard.apiUrlHint': { zh: '任意 OpenAI 兼容地址，例如 https://api.deepseek.com', en: 'Any OpenAI-compatible endpoint, e.g. https://api.deepseek.com' },
  'onboard.apiKeyLabel': { zh: 'API Key', en: 'API Key' },
  'onboard.apiProbe': { zh: '探测并创建', en: 'Probe & create' },
  'onboard.apiProbing': { zh: '正在探测模型列表…', en: 'Probing models…' },
  'onboard.apiFillBoth': { zh: '请填写 Base URL 和 API Key', en: 'Please fill in both the Base URL and the API key' },
  'onboard.apiProbeFailed': { zh: '探测失败：{msg}', en: 'Probe failed: {msg}' },
  'onboard.apiSaveFailed': { zh: '保存配置失败：{msg}', en: 'Failed to save the config: {msg}' },
  'onboard.doneTitle': { zh: '配置完成！', en: 'All set!' },
  'onboard.doneApiDesc': { zh: '已创建服务商「{name}」，发现 {n} 个模型。现在就可以开始对话了。', en: 'Provider "{name}" created with {n} models discovered. You can start chatting right away.' },
  'onboard.doneStart': { zh: '开始对话', en: 'Start chatting' },
  'onboard.oauthTitle': { zh: '选择要登录的订阅账号', en: 'Choose a subscription to log in with' },
  'onboard.oauthClaudeDesc': { zh: '使用 Sonnet / Opus 等模型，无需 API Key', en: 'Sonnet / Opus models, no API key needed' },
  'onboard.oauthCodexDesc': { zh: '使用 Codex 模型，请求自动转换为 Responses API 格式', en: 'Codex models, requests auto-converted to the Responses API' },
  'onboard.oauthNote': { zh: '中国用户需要全程代理（Clash/VPN）。点击后会在「设置 → 订阅登录」中打开官方授权流程。', en: 'Users in China need a proxy (Clash/VPN) throughout. Clicking opens the official auth flow in Settings → Subscription login.' },
  ...
  'settings.meAliasesHint': { zh: '（替代模型 ID，回车添加）', en: '(alternate model IDs — press Enter to add)' },
  'settings.meRequestIds': { zh: '请求名池', en: 'Request IDs' },
  'settings.meRequestIdsHint': { zh: '（实际发给网关的模型 ID，可多个轮换；回车添加）', en: '(the model IDs actually sent to the gateway — several rotate; press Enter to add)' },
  ...
  // Credential vault (encrypted token store — values never ride the list)
  'settings.credentialsVault': { zh: '凭证保管库', en: 'Credential Vault' },
  'settings.credentialsVaultDesc': { zh: '凭证集中保管：加密落盘在本机服务器，永不进代码仓、永不随导出外发；GitHub PAT / PyPI token 等。', en: 'Credentials kept in one place: encrypted on this server, never committed to a repo, never sent out with an export — GitHub PATs, PyPI tokens, and the like.' },
  'settings.credVaultEmpty': { zh: '保管库为空。', en: 'The vault is empty.' },
  'settings.credVaultLoadFail': { zh: '加载失败', en: 'Failed to load' },
  'settings.credVaultAdd': { zh: '添加', en: 'Add' },
  'settings.credVaultNamePlaceholder': { zh: '名称（如 github_pat）', en: 'Name (e.g. github_pat)' },
  'settings.credVaultValuePlaceholder': { zh: '值（只在本机加密落盘）', en: 'Value (encrypted on this machine only)' },
  'settings.credVaultNotePlaceholder': { zh: '备注（可选）', en: 'Note (optional)' },
  'settings.credVaultReveal': { zh: '查看', en: 'Reveal' },
  'settings.credVaultHide': { zh: '隐藏', en: 'Hide' },
  'settings.credVaultCopy': { zh: '复制', en: 'Copy' },
  'settings.credVaultCopied': { zh: '已复制', en: 'Copied' },
  'settings.credVaultCopyFail': { zh: '复制失败', en: 'Copy failed' },
  'settings.credVaultDelete': { zh: '删除', en: 'Delete' },
  'settings.credVaultConfirmDelete': { zh: '确定删除凭证「{name}」？', en: 'Delete credential "{name}"?' },
  'settings.credVaultNeedNameValue': { zh: '请填写名称和值。', en: 'Enter a name and a value.' },
  'settings.credVaultSaveFail': { zh: '保存失败', en: 'Failed to save' },
  'settings.credVaultRevealFail': { zh: '读取失败', en: 'Failed to reveal' },
  'settings.credVaultJustNow': { zh: '刚刚更新', en: 'updated just now' },
  'settings.credVaultMinutesAgo': { zh: '{n} 分钟前更新', en: 'updated {n} min ago' },
  'settings.credVaultHoursAgo': { zh: '{n} 小时前更新', en: 'updated {n} h ago' },
  'settings.credVaultDaysAgo': { zh: '{n} 天前更新', en: 'updated {n} d ago' },
  ...
  'settings.meFacePinWarn': { zh: '手动钉选会覆盖自动规则。把 Claude 模型钉到非 Anthropic 面会丢失思考块签名，导致多轮对话被上游拒绝。', en: 'A manual pin overrides the automatic rule. Pinning a Claude model to a non-Anthropic face drops thinking-block signatures, which upstream rejects on later turns.' },
  'settings.meFaceAutoResolved': { zh: '自动选择结果：{protocol}（{face} 面）', en: 'Automatically selected: {protocol} ({face} face)' },
  'settings.meFaceAutoPending': { zh: '自动选择结果解析中…', en: 'Resolving the automatic selection…' },
  'settings.meFaceAutoRefused': { zh: '自动规则无法路由该模型：{error}', en: 'The automatic rule cannot route this model: {error}' },
  ...
  'settings.wireFacesHint': { zh: '同一账号、共用密钥的另一条线路——地址决定打到哪里，协议决定对话格式；留空即单面网关', en: 'another line of the same account, keys shared — the URL says where to send, the protocol says how to speak; empty = single-face gateway' },
  'settings.addFace': { zh: '+ 协议面', en: '+ Face' },
  'settings.addFaceTitle': { zh: '新增一条备用协议面（同一套密钥，另一条协议线）', en: 'Add an alternate wire face (same keys, another protocol line)' },
  'settings.noFaces': { zh: '未配置备用协议面——所有模型都走上方默认地址', en: 'No alternate faces declared — every model uses the default address above' },
  'settings.faceProtoTitle': { zh: '这条线路用哪种协议对话（请求格式，和地址是两回事）', en: 'Which protocol this line speaks (the request format — a different question from the URL)' },
  ...
  'local.extDead': { zh: '已安装但凭证已失效', en: 'Installed but credential expired' },
  'local.browserExtOutdated': { zh: '扩展有新版本（{old} → {new}）——重新下载 ZIP 覆盖加载即可升级（已自动配对，零配置）：', en: 'A newer extension is available ({old} → {new}) — download the ZIP and load it over the old one to upgrade (pre-paired, zero config):' },
  'local.browserExtStranded': { zh: '检测到旧版扩展因凭证失效连不上（它自己无法恢复）——重新下载扩展 ZIP（已自动配对、零配置），加载即恢复：', en: 'An older extension is locked out with a dead credential (it cannot recover by itself) — download the extension ZIP (pre-paired, zero config) and load it to recover:' },
  ...
  'local.roleChoose': { zh: '当前 Tofu 以源码方式运行 —— 按这台电脑的角色选装：', en: 'Tofu is running from source — pick the install for this machine\'s role:' },
  'local.agentRoleHead': { zh: '受控端 · 轻量', en: 'Agent · lightweight' },
  'local.agentRoleNote': { zh: '—— 从另一台电脑访问（如 ssh 转发）选它：只让服务器操作那台电脑', en: '—— pick this when browsing from another machine (e.g. ssh tunnel): the server drives that machine only' },
  'local.fullRoleHead': { zh: '完整桌面版', en: 'Full desktop app' },
  'local.fullRoleNote': { zh: '—— 这台电脑就是服务器本机：装它，托盘一键开启', en: '—— pick this when this machine IS the server: tray one-click enable' },
  ...
  'local.desktopFloorLead': { zh: '让 AI 操作这台电脑 —— 安装轻量受控端（内置配对凭证与通路，装完启动即自动连上）：', en: 'To let the AI drive this computer, install the lightweight agent (credentials and routes built in — it connects by itself on first launch):' },
  'local.desktopRemote': { zh: 'Tofu 运行在远程服务器上。在你自己的电脑安装桌面版，再用下方生成的连接行完成连接：', en: 'Tofu runs on a remote server. Install the desktop app on your own machine, then finish attaching with the connect line generated below:' },
  'local.desktopRemoteAgent': { zh: 'Tofu 运行在远程服务器上 —— 让 AI 操作这台电脑：', en: 'Tofu runs on a remote server — let the AI drive this computer:' },
  'local.agentDownloadFor': { zh: '受控端·轻量', en: 'Lightweight agent' },
  'local.agentStep1': { zh: '① 下载并安装受控端（只让服务器操作这台电脑 —— 轻量 · 无界面 · 托盘配置）：', en: '1. Download and install the agent (lets the server drive this machine only — light, no UI, configured from the tray):' },
  'local.agentBundleBtn': { zh: '下载受控端 ZIP（已内置配对凭证）', en: 'Download the agent ZIP (credentials built in)' },
  'local.agentBundleNote': { zh: '解压 ZIP 后运行安装程序（两个文件要在一起）——装完启动即自动连上，全程无需输入。', en: 'Unzip, then run the installer (keep both files together) — it connects by itself on first launch, zero input.' },
  ...
  'local.awaitingAgent': { zh: '受控端凭证已随安装包内置，等待它首次连入……它会自己寻找服务器并自动重试（直连内网 → 局域网广播 → 自动隧道），一般一分钟内变绿；迟迟未变绿时，看受控端托盘菜单的「链路」一行——它会明说：连不上 / 被代理拦截 / 鉴权失败。', en: 'The credential rode the installer — waiting for the agent\'s first contact… it finds the server and retries by itself (direct LAN → LAN broadcast → automatic tunnel), usually green within a minute. If it stays red, the agent tray\'s “Link” line says exactly why: unreachable / proxy-blocked / auth failed.' },
  ...
  'local.mintToken': { zh: '生成连接行', en: 'Generate connect line' },
  'local.diagTitle': { zh: '受控端连不上？把它的诊断信息粘贴到这里', en: 'Agent won\'t connect? Paste its diagnostics here' },
  'local.diagDesc': { zh: '在受控端窗口点「复制诊断信息」（或托盘菜单同名项），回到这里粘贴提交——服务器会直接存盘，排查时立刻能读到，不用截图不用转述。', en: 'Click "Copy diagnostics" in the agent window (or the tray menu), paste it here and submit — it is stored on the server, immediately readable for debugging. No screenshots, no retelling.' },
  'local.diagPlaceholder': { zh: 'Ctrl+V 粘贴诊断信息……', en: 'Ctrl+V to paste the diagnostics…' },
  'local.diagSubmit': { zh: '提交诊断', en: 'Submit diagnostics' },
  'local.diagDone': { zh: '已收到——服务器已存盘，可以去排查了', en: 'Received — stored on the server, ready for debugging' },
  'local.diagEmpty': { zh: '先粘贴诊断信息再提交', en: 'Paste the diagnostics first' },
  'local.diagFailed': { zh: '提交失败——稍后再试', en: 'Submit failed — try again later' },
  'local.diagRecent': { zh: '最近提交', en: 'Recent submissions' },
  ...
  'paper.noteBtn': { zh: '记一笔', en: 'Note' },
  'paper.noteFromSelection': { zh: '把这条批注挂到选中的文字上', en: 'Save a margin note on this selection' },
  'paper.notePlaceholder': { zh: '写点什么…(你自己的话最管用)', en: 'Write something… (your own words stick best)' },
  'paper.noteSave': { zh: '保存', en: 'Save' },
  'paper.noteCancel': { zh: '取消', en: 'Cancel' },
  'paper.noteDelete': { zh: '删除', en: 'Delete' },
  'paper.noteAsk': { zh: '就这条问 AI', en: 'Ask AI about this' },
  'paper.noteOrphans': { zh: '找不到原位置的批注(报告已重生成)', en: 'Notes whose anchor is gone (report regenerated)' },
  'paper.deepenBtn': { zh: '再深一层', en: 'Go deeper' },
  'paper.deriveBtn': { zh: '逐步推导', en: 'Derive step-by-step' },
  'paper.deepenRunning': { zh: '深挖中…', en: 'Deepening…' },
  'paper.deepenCached': { zh: '缓存', en: 'cached' },
  'paper.xpCheckpointTitle': { zh: '随堂检查', en: 'Checkpoint' },
  'paper.xpFlipHint': { zh: '点击翻面看答案', en: 'tap to reveal the answer' },
  ...
  'paper.xpPassTermfill': { zh: '术语补全', en: 'Glossary' },
  'paper.xpPassCheckpoints': { zh: '检查点', en: 'Checkpoints' },
  'paper.xpPassDeepen': { zh: '深挖', en: 'Deep dive' },
  ...
  'mcp.toolsCountOf': { zh: '{a}/{b} 个工具', en: '{a}/{b} tools' },
  'mcp.toolsToggleTitle': { zh: '按工具开关——关闭的工具不再提供给模型（减少每次请求的工具 schema 占用）', en: 'Per-tool toggles — disabled tools are no longer offered to the model (slims the per-request tool schema)' },
  'mcp.toolsEnabledOf': { zh: '{a}/{b} 个工具已启用', en: '{a}/{b} tools enabled' },
  'mcp.toolsToggleFailed': { zh: '保存工具开关失败: {err}', en: 'Failed to save tool toggle: {err}' },
  ...
  'projectBrain.statusTrigFollowUp': { zh: '追问', en: 'follow-up' },
  'projectBrain.watchFollowUp': { zh: '继续追问', en: 'Follow up' },
  'projectBrain.watchFollowUpPlaceholder': { zh: '就这条回答继续问…', en: 'Ask a follow-up about this answer…' },
  'projectBrain.watchFollowUpSend': { zh: '发送', en: 'Send' },
  'projectBrain.watchFollowUpFailed': { zh: '追问失败', en: 'Follow-up failed' },
  'projectBrain.watchFollowUpQ': { zh: '追问', en: 'Follow-up' },
  'projectBrain.watchRequestFix': { zh: '请求修复', en: 'Request fix' },
  'projectBrain.watchFixSend': { zh: '发到任务板', en: 'Post to board' },
  'projectBrain.watchFixPosted': { zh: '已发到任务板 — 大脑会自动派发给一个对话，切到「任务板」页可点进该对话跟进。', en: 'Posted to the board — the brain dispatches it to a conversation you can open from the Board tab.' },
  'projectBrain.watchFixFailed': { zh: '派发失败', en: 'Could not post' },
  ...
  //    one-line plain-language caption above the body, Row/Section = the
  //    detail rows inside. The backend display string stays as the "Call"
  //    detail row; these keys are the user-facing surface. ──
  'motionSrc': { zh: '视频', en: 'Video' },
  'motionHead.envCheck': { zh: '检查了视频工具链', en: 'Checked the video toolchain' },
  'motionHead.storyboard': { zh: '校验了分镜脚本与字幕的一致性', en: 'Validated the storyboard against its transcript' },
  'motionHead.check': { zh: '对一个镜头跑了静态质量门', en: 'Ran the static quality gates on a scene' },
  'motionHead.render': { zh: '渲染了一个镜头', en: 'Rendered a scene to video' },
  'motionHead.probe': { zh: '读取了一个媒体文件的规格', en: 'Inspected a media file' },
  'motionHead.concat': { zh: '把所有镜头拼成了成片', en: 'Assembled the scenes into the final video' },
  'motionHead.narrate': { zh: '合成了配音音轨', en: 'Synthesized the narration track' },
  'motionHead.mux': { zh: '把配音合入了视频', en: 'Merged narration into the video' },
  'motionHead.produceVideo': { zh: '启动了一个视频生成任务', en: 'Started a video job' },
  ...
  'motionWhy.render': { zh: '把一个镜头的合成经无头 Chrome 渲成 MP4（确定性）。', en: 'Renders one scene composition to MP4 via headless Chrome (deterministic).' },
  'motionWhy.probe': { zh: '读取编码 / 分辨率 / 帧率 / 时长 / 是否有音轨 —— 渲染后的规格核查。', en: 'Reads codec / resolution / fps / duration / audio-track from a media file — the post-render spec check.' },
  'motionWhy.concat': { zh: '把逐镜头 MP4 拼成一条成片；规格不一致的镜头会被归一到第一个镜头的规格。', en: "Joins the per-scene MP4s into one final video; mismatched scenes are normalized to the first scene's spec." },
  'motionWhy.narrate': { zh: '为每个镜头合成一条配音 WAV，并报告每个镜头的目标时长（对齐清单）。', en: 'Synthesizes one narration WAV per scene and reports the duration each scene must become (alignment manifest).' },
  'motionWhy.mux': { zh: '视频流直接拷贝，配音轨转为标准化 AAC 合入 —— 得到交付文件。', en: 'Copies the video stream and merges the narration track as normalized AAC — the deliverable file.' },
  'motionWhy.produceVideo': { zh: '一句话 → 带配音的成片。任务在后台运行，进度见视频面板。', en: 'One sentence → finished narrated video. The job runs in the background; progress shows in the video panel.' },
  ...
  'motionRow.absent': { zh: '未找到', en: 'not found' },
  'motionRow.verdict': { zh: '结论', en: 'Verdict' },
  'motionRow.gatesPass': { zh: '全部质量门通过', en: 'all gates passed' },
  'motionRow.gatesFail': { zh: '质量门未过', en: 'gate failed' },
  'motionRow.category': { zh: '失败类型', en: 'Failure kind' },
  'motionRow.elapsed': { zh: '耗时', en: 'Elapsed' },
  'motionRow.gates': { zh: '执行的门', en: 'Gates run' },
  'motionRow.errors': { zh: '错误数', en: 'Errors' },
  'motionRow.transcriptSpan': { zh: '文案时长区间', en: 'Transcript span' },
  'motionRow.output': { zh: '输出', en: 'Output' },
  'motionRow.renderTime': { zh: '渲染耗时', en: 'Render time' },
  'motionRow.wall': { zh: '墙钟', en: 'Wall clock' },
  'motionRow.codec': { zh: '编码', en: 'Codec' },
  'motionRow.resolution': { zh: '分辨率', en: 'Resolution' },
  'motionRow.fps': { zh: '帧率', en: 'Frame rate' },
  'motionRow.duration': { zh: '时长', en: 'Duration' },
  'motionRow.audioTrack': { zh: '音轨', en: 'Audio track' },
  'motionRow.audioYes': { zh: '有', en: 'present' },
  'motionRow.audioNo': { zh: '无声', en: 'silent' },
  'motionRow.audioVerified': { zh: '已验证存在', en: 'verified present' },
  'motionRow.deliverable': { zh: '交付文件', en: 'Deliverable' },
  'motionRow.probeFailed': { zh: '探测失败 — 不是可读的媒体文件', en: 'probe failed — not a readable media file' },
  'motionRow.scenes': { zh: '镜头数', en: 'Scenes' },
  'motionRow.alignment': { zh: '对齐方式', en: 'Alignment' },
  'motionRow.overflow': { zh: '溢出', en: 'Overflow' },
  'motionRow.sceneDur': { zh: '配音 {a} → 镜头 {t}', en: 'audio {a} → scene {t}' },
  'motionRow.narrateDegraded': { zh: '未配置 TTS 槽位 — 本次交付无声视频。', en: 'No TTS slot configured — the video ships silent.' },
  'motionRow.call': { zh: '调用', en: 'Call' },
  'motionRow.taskId': { zh: '任务', en: 'Task' },
  'motionRow.topic': { zh: '主题', en: 'Topic' },
  'motionRow.direction': { zh: '方向', en: 'Direction' },
  'motionRow.quality': { zh: '画质', en: 'Quality' },
  'motionRow.depth': { zh: '深度', en: 'Depth' },
  'motionRow.deduped': { zh: '备注', en: 'Note' },
  'motionRow.dedupedText': { zh: '已并入正在运行的任务', en: 'joined the already-running job' },
  'motionRow.jobFailed': { zh: '任务启动失败', en: 'job failed to start' },
  'motionSec.deps': { zh: '依赖', en: 'Dependencies' },
  'motionSec.issues': { zh: '问题', en: 'Issues' },
  'motionSec.problems': { zh: '要修的问题', en: 'Problems to fix' },
  'motionSec.errors': { zh: '错误', en: 'Errors' },
  'motionSec.warnings': { zh: '警告', en: 'Warnings' },
  ...
  'projectBrain.actDelete': { zh: '删除', en: 'Delete' },
  'projectBrain.actDeleteConfirm': {
    zh: '永久删除这个 epic？它将从任务板上彻底移除（不影响任何对话）。',
    en: 'Delete this epic permanently? It is removed from the board entirely (conversations are unaffected).',
  },
