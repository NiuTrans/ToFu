...
我们在\ref{sec:audit_results}小节中，汇报了基于异构大语言模型裁判池（LLM-as-a-Judge）对现有对话检索基准进行 \textsc{CRB-Eval} 质量审计的综合平均得分。为了提供更细粒度的评估视角，并充分展示不同架构、不同规模的裁判模型在各项评估任务上的打分分布与一致性，本附录提供了详细的模型打分热力图。
...
\reviewORprint{
    ...
    \section*{学术论文:}
    \begin{enumerate}[leftmargin=*]
        \item CRB-Suite: A Framework for Evaluating and Synthesizing Conversational Retrieval Benchmarks \quad ACL 2026 main\quad 第二作者
