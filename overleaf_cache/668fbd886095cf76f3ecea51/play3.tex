...
\begin{figure}[!t] % 图形浮动体
  ...
  \begin{tikzpicture} % 开始绘图
    ...
    \begin{axis}[
      ...
      width=.45\textwidth,
      height=.45\textwidth,
      legend style={at={(0.61,0.75)}, anchor=south west},
      xlabel={}, % X轴标签
      ...
      ymin=0.995, ymax=1.012, % Y轴范围
      ytick={0.9975, 1.000, 1.0025, 1.005, 1.0075, 1.010, 1.012}, % Y轴刻度
      yticklabels={0.9975, 1.000, 1.0025, 1.005, 1.0075, 1.010, 1.012}, % Y轴刻度标签
      xmin=0, xmax=11, % X轴范围
      xtick={},
      xticklabels={},
      legend style={yshift=-6pt, xshift=-2em, legend plot pos=right, font={\large}, cells={anchor=west}} % 图例样式
    ...
    coordinates {(1,1.000342486) (2,1.007052629) (3,1.005996143) (4,1.005902537) (5,1.00596991) (6,1.006555008) (7,1.005656004) (8,1.00530398) (9,1.006215302) (10,1.007139128)};
