...
\title{基于检索增强生成技术的多轮问答基准构建与\\\quad\quad\quad\quad\quad\quad\;评估方法研究}% 论文中文题目
\author{}% 论文作者
\advisor{}% 指导教师：姓名 专业技术职务 工作单位
\advisorsec{计算机科学与工程学院}% 指导老师附加信息 或 第二指导老师信息
...
\research{}% 研究方向
\authorno{}% 学号
\chinesedate{2026~年~6~月}%  封面页脚日期
\submissiondate{2026年4月}% 论文提交日期
\oraldefencedate{2026年5月}% 论文答辩日期
...
\englishtitle{Research on the Construction and Evaluation Methods of a Multi-turn Question Answering Benchmark Based on Retrieval-Augmented Generation Technology}% 论文英文题目
\englishauthor{}% 论文作者
\englishadvisor{}% 指导教师
...
\englishdate{June 2026}% 毕业日期：春季 April 夏季为June、秋季为September 冬季为December
%-
%-> 生成封面
%-
