...
(function (F) {
  ...
  // Only these 5 pages exist in the UI. reconcile is the daily view: it is
  // the page that answers "what should I do today", recomputed on each visit.
  var VALID_PAGES = { overview: 1, simulator: 1, brain: 1, dashboard: 1, reconcile: 1 };
  ...
  function navigate(page) {
    ...
    switch (page) {
      ...
      case "dashboard":
        ...
        break;
      case "reconcile":
        if (F.loadReconcilePage) F.loadReconcilePage();
        break;
      case "brain":
