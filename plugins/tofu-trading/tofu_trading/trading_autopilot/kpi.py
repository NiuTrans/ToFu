...
from tofu_trading.trading import fetch_asset_info, fetch_price_history
    ...
    *,
    ...
    Args:
        ...
        trading_provider:  Optional :class:`~tofu_trading.protocols.TradingDataProvider` for
                        ...
                        ``tofu_trading.trading`` module functions (production path).
