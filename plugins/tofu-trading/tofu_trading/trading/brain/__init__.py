...
Architecture note (2026-04):
  ...
  ``tofu_trading.trading_autopilot``, ``tofu_trading.trading_signals``, ``tofu_trading.trading_risk``,
  and ``tofu_trading.trading.screening``. It allows callers to use a single
  ``from tofu_trading.trading.brain import X`` import path.  The pipeline module
  delegates core context gathering to ``tofu_trading.trading_autopilot.cycle._gather_context()``
...
try:
    from tofu_trading.trading_signals import compute_signal_series, compute_signal_snapshot  # noqa: F401
...
# Risk
try:
    from tofu_trading.trading_risk import (  # noqa: F401
        kelly_fraction,
        risk_parity_weights,
...
# KPI
try:
    from tofu_trading.trading_autopilot.kpi import calculate_kpis, pre_backtest_evaluate  # noqa: F401
...
# Reasoning
try:
    from tofu_trading.trading_autopilot.reasoning import build_autopilot_prompt, parse_autopilot_result  # noqa: F401
...
# Correlation
try:
    from tofu_trading.trading_autopilot.correlation import build_correlation_context, correlate_intel_items  # noqa: F401
...
# Outcome tracking
try:
    from tofu_trading.trading_autopilot.outcome import track_recommendation_outcomes  # noqa: F401
...
# Screening
try:
    from tofu_trading.trading.screening import (  # noqa: F401
        fetch_asset_ranking,
