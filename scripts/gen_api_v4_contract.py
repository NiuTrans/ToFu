#!/usr/bin/env python3
"""Generate API v4 server types and client-language contracts."""
...
OUTPUTS = {
    ...
    'swift': os.path.join(
        ROOT, 'ios', 'Sources', 'TofuClientCore', 'ApiV4Generated.swift'),
}
...
def _swift_client(document: dict[str, Any]) -> str:
    builds = document['x-tofu-minimum-builds']
    desktop = json.dumps(builds['desktop'])
    return f'''// Generated by scripts/gen_api_v4_contract.py; DO NOT EDIT.
...
public enum ApiV4Contract {{
    ...
    public static let minDesktopBuild = {desktop}
    public static let minAndroidBuild = {builds['android']}
