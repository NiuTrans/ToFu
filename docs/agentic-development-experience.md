...
```
<project>/.tofu/memories/          ← project-scoped memories (2026-07 split; skills 时代的 .tofu/skills/*.md 已迁移至此)
<project>/.tofu/skills/<id>/       ← project-scoped skill packages（与 memory 是不同名词，见 lib/skills/）
<data>/memories/global/            ← global memories (server-side store, shared across projects; 2026-06)
<data>/skills/global/<id>/         ← global skill packages (server-side store; 2026-07)
```
